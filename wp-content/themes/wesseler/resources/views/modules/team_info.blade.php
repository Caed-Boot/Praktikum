        ...
        @endphp
            <div class="flex flex-row md:flex-col justify-center md:items-center transition-all duration-500 section-img">
                <div class="flex md:flex-col md:items-center gap-6">
                    <img src="{{$teamUrl}}" class="object-cover object-center w-2/5 md:w-4/5 lg:h-3/5">
                    <div class="flex flex-col justify-start space-y-2 grid-team__info md:w-4/5 ">
                        ...
                        @elseif ($teamTelefon)
                            <a class=" font-semibold text-m-primary"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" 
                            fill="currentColor" class="size-4 inline-block">
