...
<section class="grid w-[90%] mx-auto md:grid-cols-2 grid-team">
    ...
    @foreach ($data['team_repeater'] as $item)
        ...
        <div class="flex mb-20 md:mb-40 md:flex-col md:justify-center md:items-center">
            <div class="flex gap-3 md:mb-24 md:flex-col md:justify-center md:items-center">
                <img src="{{$teamUrl}}" class="object-cover w-2/5 md:w-4/6 h-full">
                
                <div class="flex flex-col justify-between space-y-3 text-base md:w-48 md:max-h-24 md:text-base lg:w-64 xl:w-80 grid-team__info">
                    {!! $teamInfo !!} 
