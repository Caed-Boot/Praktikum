<div class="flex flex-col justify-center mx-auto my-24 w-[90%] md:w-[80%] lg:w-[70%] accordion">
    ...
    @foreach ($data['accordion'] as $item)
        ...
        <div id="accordion-collapse-heading-{{ $openId }}" class=" accordion-title px-8">
        ...
        <ul id="accordion-collapse-body-{{ $bodyId }}" class=" w-10/12 transition-all duration-300 ease-in-out accordion-body">
