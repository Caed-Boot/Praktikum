...
<header class="flex fixed bg-white w-full h-20 md:h-auto justify-between z-40 shadow-xl lg:px-14 xl:px-36 header">
    ...
    @if (has_nav_menu('primary_navigation'))
      <div class=" flex justify-between items-center p-2 cursor-pointer md:hidden" >
      ...
      <nav class=" flex-col bg-gray  items-center hidden-menu w-full h-full transition-all duration-700 fixed z-40 p-10 overflow-y-scroll  md:static md:p-8 md:bg-white  md:overflow-y-visible  primary-nav">
          ...
          stroke-width="1.5" 
          stroke="currentColor" 
          class="size-6 text-turquoise w-10 h-10 ml-auto cursor-pointer close-menu transition-all duration-200 hover:text-white md:hidden">
          ...
          {!! wp_nav_menu([
            ...
            <div class="inline-block"> 
              ...
              stroke-width="1.5" 
              stroke="currentColor" 
              class="size-6 text-turquoise cursor-pointer relative top-1 left-3 md:left-0 transition-all duration-150 arrow">
                <path 
